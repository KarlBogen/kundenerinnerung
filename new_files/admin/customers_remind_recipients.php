...
$reminder_query_raw = "SELECT nr.*,
                             ...
                             FROM " . TABLE_CUSTOMERS_REMIND_RECIPIENTS . " nr
  ...
  switch ($action) {
    case 'remind':
      ...
      if (xtc_db_num_rows($check_mail_query) > 0) {
        ...
        require_once(DIR_FS_CATALOG . DIR_WS_CLASSES . 'class.customers_remind.php');
      ...
      xtc_redirect(xtc_href_link(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action'))));
      break;
    ...
    case 'export':
      ...
      if (xtc_db_num_rows($reminder_query) > 0) {
        ...
        header('Content-disposition: attachment; filename=customers_remind_recipients.csv');
    ...
    case 'deleteall':
      ...
      if (xtc_db_num_rows($delete_mail_query) < 1) {
        $messageStack->add_session(sprintf(DELETE_INACTIVE_RECIPIENTS_NO_ENTRYS_FOUND, xtc_db_input($_POST['days'])), 'error');
        xtc_redirect(xtc_href_link(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action'))));
      }
      break;
      ...
      <td class="boxCenter">
        ...
        ?>
          <div class="main flt-l pdg2 mrg5" style="margin-left:20px;">
            <?php echo xtc_draw_form('cgroup', FILENAME_CUSTOMERS_REMIND_RECIPIENTS, '', 'get'); ?>
          ...
          <div class="main flt-l pdg2 mrg5" style="margin-left:20px;">
            <?php echo xtc_draw_form('search', FILENAME_CUSTOMERS_REMIND_RECIPIENTS, '', 'get'); ?>
          ...
          <div class="main flt-l pdg2 mrg5" style="margin-left:20px;">
            <?php echo '<a class="button" style="margin-top:1px;" onclick="this.blur();" href="' . xtc_href_link(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action')) . 'action=export') . '">' . BUTTON_EXPORT . '</a>'; ?>
          </div>
            ...
            <tr>
              <td class="boxCenterLeft">
                <table class="tableBoxCenter collapse">
                  <tr class="dataTableHeadingRow">
                    <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_EMAIL . xtc_sorting(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, 'email'); ?></td>
                    <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_FIRSTNAME . xtc_sorting(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, 'firstname'); ?></td>
                    <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_LASTNAME . xtc_sorting(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, 'lastname'); ?></td>
                    <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_CUSTOMERS_STATUS . xtc_sorting(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, 'cstatus'); ?></td>
                    <td class="dataTableHeadingContent txta-c"><?php echo TABLE_HEADING_STATUS . xtc_sorting(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, 'status'); ?></td>
                    <td class="dataTableHeadingContent txta-c"><?php echo TABLE_HEADING_DATE_ADDED . xtc_sorting(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, 'date_added'); ?></td>
                  ...
                  while ($reminder = xtc_db_fetch_array($reminder_query)) {
                    ...
                    if (isset($oInfo) && is_object($oInfo) && ($reminder['customers_email_address'] == $oInfo->customers_email_address)) {
                      echo '<tr class="dataTableRowSelected" onmouseover="this.style.cursor=\'pointer\'" onclick="document.location.href=\'' . xtc_href_link(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action', 'mail')) . 'mail=' . md5($oInfo->customers_email_address) . '&action=edit') . '\'">' . "\n";
                    } else {
                      echo '<tr class="dataTableRow" onmouseover="this.className=\'dataTableRowOver\';this.style.cursor=\'pointer\'" onmouseout="this.className=\'dataTableRow\'" onclick="document.location.href=\'' . xtc_href_link(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action', 'mail')) . 'mail=' . md5($reminder['customers_email_address'])) . '\'">' . "\n";
                    }
                  ?>
                    ...
                    <td class="dataTableContent txta-r"><?php if (isset($oInfo) && is_object($oInfo) && ($reminder['customers_email_address'] == $oInfo->customers_email_address)) {
                                                          ...
                                                          echo '<a href="' . xtc_href_link(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, 'page=' . $page . '&mail=' . md5($reminder['customers_email_address'])) . '">' . xtc_image(DIR_WS_IMAGES . 'icon_arrow_grey.gif', IMAGE_ICON_INFO) . '</a>';
                                                        } ?>&nbsp;</td>
                  </tr>
                <?php } ?>
                </table>
                    ...
                    <td class="boxCenterLeft">
                      <table style="width:100%;">
                        <tr>
                          ...
                          $heading = array();
                          $contents = array();
                          $heading[] = array('text' => xtc_image(DIR_WS_ICONS . ('time_delete.png')) . '   <b>' . DELETE_INACTIVE_RECIPIENTS_TITLE . '</b>');
                          $contents = array('form' => xtc_draw_form('status', FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action', 'mail')) . '&action=deleteall'));
                          $contents[] = array('text' => DELETE_INACTIVE_RECIPIENTS_INFO);
                          $array = array();
                          $array[] = array('id' => '10', 'text' => '10' . DELETE_INACTIVE_RECIPIENTS_TEXT_DAYS);
                          $array[] = array('id' => '30', 'text' => '30' . DELETE_INACTIVE_RECIPIENTS_TEXT_DAYS);
                          $array[] = array('id' => '90', 'text' => '90' . DELETE_INACTIVE_RECIPIENTS_TEXT_DAYS);
                          $contents[] = array('text' => '<br /><b>' . DELETE_INACTIVE_RECIPIENTS_SELECT_LABEL . ' ' . xtc_draw_pull_down_menu('days', $array, '30') . '</b>');
                          $contents[] = array('align' => 'left', 'text' => '<br /><input type="submit" class="button" onclick="this.blur();" value="' . DELETE_INACTIVE_RECIPIENTS_BUTTONTEXT . '"/>');
              ...
              switch ($action) {
                case 'delete':
                  ...
                  $contents = array('form' => xtc_draw_form('status', FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action', 'mail')) . 'mail=' . md5($oInfo->customers_email_address)  . '&action=deleteconfirm'));
                  $contents[] = array('text' => TEXT_INFO_DELETE_INTRO);
                  $contents[] = array('text' => '<br /><b>' . $oInfo->customers_email_address . '</b>');
                  $contents[] = array('align' => 'center', 'text' => '<br /><input type="submit" class="button" onclick="this.blur();" value="' . BUTTON_UNSUBSCRIBE . '"/> <a class="button" onclick="this.blur();" href="' . xtc_href_link(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action', 'mail')) . 'mail=' . md5($oInfo->customers_email_address)) . '">' . BUTTON_CANCEL . '</a>');
                  break;
                ...
                default:
                  if (isset($oInfo) && is_object($oInfo)) {
                    ...
                    $reminder_history_query = xtc_db_query("SELECT *
                                                                          FROM " . TABLE_CUSTOMERS_REMIND_RECIPIENTS_HISTORY . "
                    ...
                    if ($oInfo->mail_status == '1') {
                      $contents[] = array('align' => 'center', 'text' => '<a class="button" onclick="this.blur();" href="' . xtc_href_link(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action', 'mail')) . 'mail=' . md5($oInfo->customers_email_address) . '&action=delete') . '">' . BUTTON_UNSUBSCRIBE . '</a>');
                    }

                    if ($oInfo->mail_status == '0') {
                      $contents[] = array('align' => 'center', 'text' => '<a class="button" onclick="this.blur();" href="' . xtc_href_link(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action', 'mail')) . 'mail=' . md5($oInfo->customers_email_address) . '&action=remind') . '">' . BUTTON_REMIND . '</a>');
                      $contents[] = array('align' => 'center', 'text' => '<a class="button" onclick="this.blur();" href="' . xtc_href_link(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action', 'mail')) . 'mail=' . md5($oInfo->customers_email_address) . '&action=delete') . '">' . BUTTON_UNSUBSCRIBE . '</a>');
                    }
                  }
                  break;
        ...
        ?>
          ...
          <table class="tableCenter" style="width:100%;">
            <tr>
              ...
              $heading = array();
              $contents = array();
              $heading[] = array('text' => '<b>' . DELETE_INACTIVE_RECIPIENTS_TITLE . '</b>');
              $contents = array('form' => xtc_draw_form('status', FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action', 'mail')) . '&action=deleteconfirmall'));
              ...
              if (xtc_db_num_rows($delete_mail_query) > 0) {
                ...
                $contents[] = array('text' => TEXT_INFO_DELETE_INTRO);
                $contents[] = array('align' => 'left', 'text' => '<br /><input type="submit" class="button" onclick="this.blur();" value="' . BUTTON_UNSUBSCRIBE . '"/> <a class="button" onclick="this.blur();" href="' . xtc_href_link(FILENAME_CUSTOMERS_REMIND_RECIPIENTS, xtc_get_all_get_params(array('action', 'mail'))) . '">' . BUTTON_CANCEL . '</a>');
              }
