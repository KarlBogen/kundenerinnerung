						...
						<td class="boxCenterFull">
							<table class="tableBoxCenter collapse">
								<tr class="dataTableHeadingRow">
									<td class="dataTableHeadingContent" style="width:12%"><?php echo TABLE_HEADING_CUSTOMER.xtc_sorting(FILENAME_CUSTOMERS_REMIND,'customers_lastname'); ?></td>
									<td class="dataTableHeadingContent" style="width:12%"><?php echo TABLE_HEADING_CUSTOMER_MAIL.xtc_sorting(FILENAME_CUSTOMERS_REMIND,'customers_email'); ?></td>
									<td class="dataTableHeadingContent" style="width:5%"><?php echo TABLE_HEADING_PRODUCT_BILD; ?></td>
									<td class="dataTableHeadingContent txta-c" style="width:5%"><?php echo TABLE_HEADING_PRODUCT_ST.xtc_sorting(FILENAME_CUSTOMERS_REMIND,'customers_st'); ?></td>
									<td class="dataTableHeadingContent"><?php echo TABLE_HEADING_PRODUCT.xtc_sorting(FILENAME_CUSTOMERS_REMIND,'products_name'); ?></td>
									<td class="dataTableHeadingContent" style="width:10%"><?php echo TABLE_HEADING_PRODUCT_DAT.xtc_sorting(FILENAME_CUSTOMERS_REMIND,'products_model'); ?></td>
									<td class="dataTableHeadingContent txta-c" style="width:10%"><?php echo TABLE_HEADING_PRODUCT_MODEL.xtc_sorting(FILENAME_CUSTOMERS_REMIND,'products_ean'); ?></td>
									<td class="dataTableHeadingContent" style="width:5%"><?php echo TABLE_HEADING_DATE_ADDED.xtc_sorting(FILENAME_CUSTOMERS_REMIND,'remind_date_added') ?></td>
