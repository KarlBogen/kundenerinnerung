...
if ($_GET['sorting']) {
  switch ($_GET['sorting']) {
    ...
    case 'customers_lastname':
      $sort = 'order by cr.customers_lastname';
      break;
    case 'customers_lastname-desc':
      $sort = 'order by cr.customers_lastname DESC';
      break;
    case 'customers_email':
      $sort = 'order by cr.customers_email_address';
      break;
    case 'customers_email-desc':
      $sort = 'order by cr.customers_email_address DESC';
      break;
    case 'products_ean':
      $sort = 'order by cr.products_name';
      break;
    case 'products_ean-desc':
      $sort = 'order by cr.products_name DESC';
      break;
    case 'products_name':
      $sort = 'order by cr.products_name';
      break;
    case 'products_name-desc':
      ...
      break;
    case 'products_model':
      $sort = 'order by cr.products_model';
      break;
    case 'products_model-desc':
      $sort = 'order by cr.products_model DESC';
      break;
    case 'remind_date_added':
      $sort = 'order by cr.remind_date_added';
      break;
    case 'remind_date_added-desc':
      $sort = 'order by cr.remind_date_added DESC';
      break;
    case 'customers_st':
      $sort = 'order by cr.customers_st';
      break;
    case 'customers_st-desc':
      $sort = 'order by cr.customers_st DESC';
      break;
  }
}
...
<body>
  ...
  <table class="tableBody">
    <tr>
      ...
      <!-- body_text //-->
      <td class="boxCenter">
        <div class="pageHeadingImage"><?php echo xtc_image(DIR_WS_ICONS . 'heading/icon_news.png', BOX_CUSTOMERS_REMIND); ?></div>
            ...
            <td class="boxCenterFull">
              <table class="tableBoxCenter collapse">
                <tr class="dataTableHeadingRow">
                  <td class="dataTableHeadingContent" style="width: 40px;"><?php echo TABLE_HEADING_CUSTOMER . xtc_sorting(FILENAME_CUSTOMERS_REMIND, 'customers_lastname'); ?></td>
                  ...
                  <?php if (MODULE_CUSTOMERS_REMIND_SENDMAIL_MINSTOCK_STATUS == 'true') { ?>
                    <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_PRODUCT_MINSTOCK . ' ' . MODULE_CUSTOMERS_REMIND_SENDMAIL_MINSTOCK . '%'; ?></td>
                  <?php } ?>
                  <td class="dataTableHeadingContent txta-c"><?php echo TABLE_HEADING_PRODUCT_ST . xtc_sorting(FILENAME_CUSTOMERS_REMIND, 'customers_st'); ?></td>
                  <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_PRODUCT . xtc_sorting(FILENAME_CUSTOMERS_REMIND, 'products_name'); ?></td>
                  <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_PRODUCT_DAT . xtc_sorting(FILENAME_CUSTOMERS_REMIND, 'products_model'); ?></td>
                  <td class="dataTableHeadingContent txta-c"><?php echo TABLE_HEADING_PRODUCT_MODEL . xtc_sorting(FILENAME_CUSTOMERS_REMIND, 'products_ean'); ?></td>
                  <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_DATE_ADDED . xtc_sorting(FILENAME_CUSTOMERS_REMIND, 'remind_date_added') ?></td>
                ...
                ?>
                  ...
                  <?php if (MODULE_CUSTOMERS_REMIND_SENDMAIL_MINSTOCK_STATUS == 'true') { ?>
                    <td class="dataTableContent txta-l">
                      <?php if ($customers_remind['mail_status'] != '1') {
                        ...
                        echo sprintf(CUSTOMERS_REMIND_STOCK_INFO, $customers_remind['products_quantity']) . sprintf(CUSTOMERS_REMIND_MINSTOCK_INFO, $totals[$customers_remind['products_id']]['COUNT'], $totals[$customers_remind['products_id']]['STOCK'], $sendstock);
                  ...
                  <td class="dataTableContent txta-c">
                    <?php echo (xtc_draw_form('del_users', FILENAME_CUSTOMERS_REMIND)); ?>
  ...
  <?php if (MODULE_CUSTOMERS_REMIND_SENDMAIL_MINSTOCK_STATUS == 'true') { ?>
    <script>
      function sendremindmail(item, mail) {
        $.confirm({
          title: 'Information',
          content: '<?php echo CUSTOMERS_REMIND_CONFIRMSEND; ?>',
